...
const CATEGORIES: { label: string; integrations: Integration[] }[] = [
  {
    ...
    integrations: [
      ...
      { name: "Hunter.io", logo: "", color: "#F36A24", lastCalledBy: "Scout", lastEndpoint: "GET /email-finder?domain=...", lastStatus: "200 OK", lastMs: "287ms" },
      ...
      { name: "Gong", logo: "", color: "#7B42F6", lastCalledBy: "Scout", lastEndpoint: "GET /calls?fromDateTime=...", lastStatus: "200 OK", lastMs: "421ms" },
      { name: "MindTickle", logo: "", color: "#FF6B35", lastCalledBy: "Ghost", lastEndpoint: "POST /training/assignments", lastStatus: "201 Created", lastMs: "234ms" },
    ],
  },
  {
    label: "Dev Tools",
  ...
  },
  {
    ...
    integrations: [
      ...
      { name: "SendGrid", logo: SI("twilio"), color: "#1A82E2", lastCalledBy: "Ghost", lastEndpoint: "POST /v3/mail/send", lastStatus: "202 Accepted", lastMs: "198ms" },
    ],
  },
  {
  ...
  },
  {
    ...
    integrations: [
      ...
      { name: "Productboard", logo: "", color: "#F55050", lastCalledBy: "Kaze", lastEndpoint: "POST /features", lastStatus: "201 Created", lastMs: "213ms" },
