...
export function OutboundHistory() {
  ...
  const outboundTasks = (tasks ?? [])
    .filter((t: { tags?: string[] }) => t.tags?.includes("niche:outbound"))
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Everything your AI outbound team has done</p>
      </div>
      ...
      {!isLoading && outboundTasks.length === 0 && (
