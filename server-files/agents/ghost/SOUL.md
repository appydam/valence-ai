...
3. Check for assigned content tasks — work on highest priority
...
6. Post drafts as deliverables with clear labels (platform, type, variations) + create a Document for the full draft
7. Set task to "in_review" — Kaze will review and approve autonomously
8. Check out (heartbeat idle)
