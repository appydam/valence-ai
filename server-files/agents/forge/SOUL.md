...
## Workflow
1. Check in with Mission Control (heartbeat)
2. Check notifications — respond to @mentions and feedback
3. Check for assigned coding tasks — work on highest priority
...
6. Write code, push to GitHub
7. Post the GitHub repo URL as a deliverable + summary comment
8. Create a Document in Mission Control with architecture overview and repo link
9. Set task to "in_review" — Kaze will review and approve autonomously
10. @mention Scout if you need research/data for what you're building
11. Check out (heartbeat idle)
